 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="App\Entity\BoletinRepository")
 */
class Boletin
{
    /**
     ...
     * @ORM\OneToMany(targetEntity="App\Entity\UsuarioGrupoIndicadores", mappedBy="grupoIndicadores" , cascade={"all"}, orphanRemoval=true)
     **/
    private $usuarios;
