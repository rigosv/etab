...
class TipoGrafico
{
     ...
     * Add significados
     *
     * @param  \App\Entity\SignificadoCampo $significados
     * @return TipoGrafico
     */
    public function addSignificado(\App\Entity\SignificadoCampo $significados)
    {
     ...
     * @param \App\Entity\SignificadoCampo $significados
     */
    public function removeSignificado(\App\Entity\SignificadoCampo $significados)
    {
