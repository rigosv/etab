...
class IndicadorAlertas
{
     ...
     * Set color
     *
     * @param  App\Entity\Alerta $color
     * @return IndicadorAlertas
     */
    public function setColor(\App\Entity\Alerta $color = null)
    {
        $this->color = $color;
     ...
     * Set indicador
     *
     * @param  App\Entity\FichaTecnica $indicador
     * @return IndicadorAlertas
     */
    public function setIndicador(\App\Entity\FichaTecnica $indicador = null)
    {
