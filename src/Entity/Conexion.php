...
class Conexion
{
     ...
     * Set idMotor
     *
     * @param  App\Entity\MotorBd $idMotor
     * @return Conexion
     */
    public function setIdMotor(\App\Entity\MotorBd $idMotor = null)
    {
     ...
     * Add origenes
     *
     * @param  \App\Entity\OrigenDatos $origenes
     * @return Conexion
     */
    public function addOrigene(\App\Entity\OrigenDatos $origenes)
    {
     ...
     * @param \App\Entity\OrigenDatos $origenes
     */
    public function removeOrigene(\App\Entity\OrigenDatos $origenes)
    {
