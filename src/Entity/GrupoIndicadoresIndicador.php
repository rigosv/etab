...
/**
 * App\Entity\GrupoIndicadoresIndicador
 *
...
class GrupoIndicadoresIndicador
{
     ...
     * @return GrupoIndicadoresIndicador
     */
    public function setIndicador(\App\Entity\FichaTecnica $indicador)
    {
     ...
     * Set grupo
     *
     * @param  \App\Entity\GrupoIndicadores $grupo
     * @return GrupoIndicadoresIndicador
     */
    public function setGrupo(\App\Entity\GrupoIndicadores $grupo)
    {
        $this->grupo = $grupo;
